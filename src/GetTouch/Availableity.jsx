...
const Availableity = () => {
    return (
        <div>
            <section className="py-6 bg-white dark:text-gray-800">
                <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row font-serif">
                    <div className="flex flex-col justify-center lg:text-left">
                        <p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-400">Get Our Connection in website and apps.</p>
                        <h1 className="py-2 text-3xl font-medium leading-tight title-font">Master in Creating Blog in your way.</h1>
                    </div>
